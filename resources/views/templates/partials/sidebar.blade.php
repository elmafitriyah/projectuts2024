    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('publisher.index') }}" data-bs-auto-close="false" role="button" aria-expanded="false" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('book.index') }}" data-bs-auto-close="false" role="button" aria-expanded="false" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
